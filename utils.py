...
def calculate_sma(data: pd.Series, n: int = 100) -> pd.Series:
    """
...
def calculate_ema(data: pd.Series, n: int = 50) -> pd.Series:
    """
...
def calculate_wma(data: pd.Series, n: int = 50) -> pd.Series:
    """
...
def calculate_hma(data: pd.Series, n: int=50) -> pd.Series:
    """
...
def calculate_dma(data: pd.Series, n: int = 50, displacement: int=-20) -> pd.Series:
    """
...
def calculate_dema(data: pd.Series, n: int=50) -> pd.Series:
    """
...
# def calculate_vma(data: pd.Series, n: int=50, vol_period: int = 20) -> pd.Series:
#     """
...
def calculate_roc(data: pd.Series, n: int = 50) -> pd.Series:
    """
...
def calculate_momentum_s(data: pd.Series, n: int = 50) -> pd.Series:
    """
...
def calculate_donchian_upper_s(data_high: pd.Series, n: int = 20) -> pd.Series:
    """
...
def calculate_donchian_lower_s(data_low: pd.Series, n: int = 20) -> pd.Series:
    """
...
# List of functions requiring a single pd.Series
series_ts_extraction_fns = [
    calculate_sma,
    calculate_ema,
    calculate_wma,
    calculate_hma,
    ...
    calculate_rsi,
    calculate_roc,
    calculate_momentum_s,
    calculate_stochastic_rsi_k,
    calculate_stochastic_rsi_d,
    calculate_ppo,
    calculate_macd,
    ...
    calculate_vhf,
    calculate_aroon_up,
    calculate_aroon_down,
    calculate_aroon_oscillator,
    calculate_bull_power,
    calculate_bear_power,
    calculate_chikou_span,
    calculate_keltner_middle,
    calculate_donchian_upper_s,  
    calculate_donchian_lower_s,  
    calculate_iv_rank,
    calculate_iv_percentile,
    # calculate_ml_rsi,
    # calculate_ml_rsi_overbought,
    # calculate_ml_rsi_oversold,
    hurst_exponent,
    calculate_iqr,
    calculate_cv,
    calculate_mad,
    ...
    calculate_nth_autocorrelation_series,
    # calculate_cusum_positive,
    # calculate_cusum_negative,
    calculate_tsi,
    calculate_kst,
    adx_proxy_from_typical_price,
    get_mean_line,
    get_up_band1,
    get_lo_band1,
    get_up_band2,
...
# List of functions requiring multiple pd.Series (OHLC)
ohlc_ts_extraction_fns = [
    calculate_vortex_plus,
    calculate_vortex_minus,
    calculate_mass_index,
    calculate_clv,
    calculate_bop,
    calculate_heikin_ashi_close,
    calculate_heikin_ashi_open,
    calculate_heikin_ashi_high,
    calculate_heikin_ashi_low,
    swing_index,
    ...
    range_indicator,
    atr,
    get_base_fractal_points,
    get_higher_fractal_points,
    calculate_adx,
    calculate_parabolic_sar_with_trend,
    calculate_tenkan_sen,
    calculate_kijun_sen,
    calculate_keltner_upper,
    calculate_keltner_lower,
    calculate_kdj_k,
    calculate_kdj_d,
    calculate_kdj_j,
    calculate_donchian_middle,
    calculate_supertrend_line,
    calculate_supertrend_trend,
    calculate_moses_indicator,
    calculate_moses_signal,
    calculate_zigzag,
    calculate_cci_turbo,
    calculate_cci_14,
    calculate_williams_percent_r,
    calculate_williams_percent_r_signal,
    calculate_alligator_jaw,
    calculate_alligator_teeth,
    calculate_alligator_lips,
    calculate_vortex_positive,
    calculate_vortex_negative,
    calculate_volatility_stop_vstop,
    calculate_volatility_stop_uptrend,
    calculate_smi_ergodic_oscillator,
    calculate_smi,
    calculate_smi_signal,
    calculate_rvi,
    calculate_short_rci,
    calculate_middle_rci,
    calculate_long_rci,
    calculate_momentum,
    calculate_median,
    calculate_upper_band,
    calculate_lower_band,
    calculate_median_ema,
    calculate_mcginley_dynamic,
    calculate_lsma,
    calculate_fisher,
    calculate_trigger,
    calculate_envelope_basis,
    calculate_envelope_upper,
    calculate_envelope_lower,
    calculate_donchian_upper,  
    calculate_donchian_lower,  
    calculate_coppock_curve,
    calculate_connors_rsi,
    calculate_choppiness_index,
    calculate_chande_kroll_stop_long,
    calculate_chande_kroll_stop_short,
    calculate_bull_bear_power,
    calculate_bbw,
    calculate_highest_expansion,
    calculate_lowest_contraction,
    calculate_balance_of_power,
    calculate_bollinger_bands_percent_b,
    calculate_alma
]

# OC (Open, Close) + derived Series
ohlc_ts_extraction_fns_oc = [
    calculate_heikin_ashi_open  # Requires ha_close_series
]

# HL (High, Low)
ohlc_ts_extraction_fns_hl = [
    calculate_vortex_plus,
    calculate_vortex_minus,
    calculate_mass_index,
    calculate_tenkan_sen,
...
# Other Combinations (e.g., H + derived Series, L + derived Series)
ohlc_ts_extraction_fns_other = [
    calculate_heikin_ashi_high,  # H + ha_open_series + ha_close_series
    calculate_heikin_ashi_low    # L + ha_open_series + ha_close_series
]